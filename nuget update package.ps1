...
$ProjDir  = Join-Path -Path $ScriptDir -ChildPath "WizardControl\"
$ProjFile  = Join-Path -Path $ScriptDir -ChildPath "WizardControl\WizardControl.csproj"
$PackFile = Join-Path -Path $ScriptDir -ChildPath "WizardControl\*.nupkg"
